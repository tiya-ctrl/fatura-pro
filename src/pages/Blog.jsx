...
const POSTS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Deposits and Partial Payments", p: "Most freelance and agency work starts with money upfront, and invoicing tools usually pretend it does not. On Essential you can record a deposit or a partial payment against an invoice, so the document shows what has been received and what is still outstanding, and reminders chase the remaining balance rather than the full amount. No more parallel spreadsheet to track who paid half." },
      { h: "UBL/XML Export", p: "Essential exports an invoice as downloadable UBL/XML intended for EN 16931 workflows. Receiving systems can apply country, network or customer-specific profile rules, so confirm the format your client accepts and validate the file before delivery. Fatura Pro does not send it through Peppol." },
      ...
      { h: "Start With the Free Trial", p: "Every new account begins with a seven-day Essential trial, no credit card required. If it fits your workflow, Essential is nine euros a month. If you run a team or agency and need quotes, recurring invoices, VAT reports or shared access, look at the Advanced plan instead." },
    ],
  },
  {
    slug: "fatura-business-plan-guide-how-to-use",
    lang: "en",
    title: "Fatura Advanced Plan: Every Feature and How to Use It",
    description: "Explore the Advanced plan: quotes, recurring invoices, VAT expense reports, five team members, online payments, multiple businesses, and API access.",
    date: "2026-08-15",
    dateModified: "2026-09-08",
    readTime: "8 min",
    ...
    sections: [
      { h: "Built for Agencies and Teams", p: "Advanced at nineteen euros a month is the most complete tier, designed for agencies, studios, teams and owners of more than one business. It includes everything in Essential, which already covers unlimited invoicing, editable payment reminders, deposits and UBL/XML export, and adds the tools that appear once more than one person is involved. Five team members are included at the flat Advanced price. New accounts start with a seven-day Essential trial; Advanced features require the Advanced plan." },
      ...
      { h: "White-Label Invoices and Priority Support", p: "On Advanced your invoices carry only your own name and logo, with no reference to the software, and you get the in-app assistant for priority support inside the app rather than waiting on email." },
      { h: "Start with the Plan You Need", p: "A new account starts with a seven-day Essential trial and does not require a card. Advanced features such as quotes, recurring schedules, expense summaries and team access require the Advanced plan, which can be cancelled through the billing portal." },
    ],
  },
  {
    slug: "invoicing-plans-free-vs-pro-vs-business",
    lang: "en",
    title: "Free vs Essential vs Advanced: How to Choose and Use Your Invoicing Plan (2026 Guide)",
    ...
    sections: [
      ...
      { h: "The Three Plans at a Glance", p: "Fatūra Pro has three levels. Free covers up to 20 invoices and 5 clients, with no card required and no time limit. Essential at 9 euros a month removes those limits and adds editable payment reminders, deposits and UBL/XML export. Advanced at 19 euros a month adds quotes, recurring invoice creation, expenses with VAT summaries, up to five team members, connected Stripe client payments, multiple business profiles, analytics, accountant export, API access and removal of Fatūra branding. New accounts receive a seven-day Essential trial; Advanced features require the Advanced plan." },
      ...
      { h: "What You Get on Free (And What You Do Not)", p: "The free plan includes the full invoice editor, your logo and branding on the document, PDF export, all 18 currencies, client management, and the dashboard showing revenue, pending and overdue totals. What it does not include: payment-reminder templates, unlimited volume, and the Advanced features listed later. Free invoices also carry a small Fatūra Invoicing credit in the footer, which is removed on the Advanced plan. Nothing expires and no card is ever requested." },
      { h: "Four Signs You Have Outgrown Free", p: "One, you are deleting old invoices to make room for new ones. Two, you are chasing late payments manually and it is costing you real hours and awkward conversations. Three, you are copying the same invoice every month for the same client. Four, someone else in your business needs to issue invoices while you are busy. The first two point to Essential; the last two point to Advanced. If none of these apply yet, stay free with a clear conscience." },
      { h: "The Essential Plan: Who It Is For", p: "Essential at 9 euros a month suits the established solo professional: consultants, designers, developers, photographers, tradespeople and small service businesses that invoice regularly. The core value is not only the higher limits; it is having the payment status and reminder text in the same workflow instead of rewriting every follow-up." },
      ...
      { h: "The Advanced Plan: Who It Is For", p: "Advanced at 19 euros a month is built for small agencies, studios, teams and people running more than one venture. It is the relevant tier when several people need shared operational records, when quotes precede invoices, when scheduled invoice creation helps with retainers, or when expenses and VAT summaries support the bookkeeping workflow. Up to five team members are included in the flat Advanced price." },
      ...
      { h: "How to Upgrade, Switch Plans or Cancel", p: "To upgrade, open Settings and click Upgrade, or use the pricing section on the homepage, choose a plan and complete Stripe checkout. New accounts receive a seven-day Essential trial. To manage a paid subscription, update the payment method, view receipts or cancel, open Settings and then Subscription. The Stripe billing portal shows the effective dates and billing details before you confirm changes." },
      { h: "Frequently Asked Questions", p: "The Free plan has no time limit and requires no card. All plans support 18 invoice currencies, kept as separate totals. Sign-in and primary navigation support English, Dutch, French, Spanish and Arabic; invoice labels support English, Dutch, French, Spanish and Arabic. Reminder templates support all five interface languages. Team access is an Advanced feature with up to five members." },
      { h: "Start Free and Upgrade Only When It Pays", p: "The right invoicing plan is the smallest one that removes the current bottleneck. Start with the Free plan, test the core invoice workflow and use the seven-day Essential trial to evaluate Essential features. Upgrade when invoice volume, payment follow-up, deposits or UBL/XML export justify Essential, or when the Advanced workflow is needed." },
    ],
  },
  {
    ...
    sections: [
      ...
      { h: "Check Roles and Shared Access", p: "Team access should let members work with the same clients, invoices, quotes and expenses without exposing subscription or company-level controls unnecessarily. Test who can edit, delete and view records, and whether the owner retains control of billing and integrations. In Fatūra Pro Advanced, invited members share operational records while owner-level areas remain restricted." },
      { h: "Turn Approved Quotes into Invoices", p: "A quote-to-invoice workflow removes retyping at the exact point where accuracy matters most. The accepted client, scope, quantities and prices should carry into the invoice, while you still review tax, dates and payment terms before sending. Fatūra Pro Advanced includes quotes that can be converted into invoices from the same workspace." },
      ...
      { h: "Review Expenses and VAT Without Overpromising", p: "Expense and VAT summaries can reduce spreadsheet work, but they do not replace an accountant or the tax authority's filing process. Check whether different currencies stay separate and whether the export contains the fields your accountant expects. Fatūra Pro Advanced tracks expenses, shows VAT summaries and provides a CSV accountant export." },
      ...
      { h: "Run a Real Workflow Test Before Migrating", p: "Before moving active billing, use representative data to test the workflow your agency needs: a client, quote conversion, deposit, recurring schedule, teammate invitation and accountant export. Fatūra Pro has a Free plan and a seven-day Essential trial. Quotes, recurring schedules, expenses and team access require Advanced." },
    ],
    faqs: [
  ...
  },
{
    ...
    lang: "en",
    title: "Arabic Invoicing Software: Interface, PDF and Reminders (2026)",
    description: "Compare Arabic invoicing workflows: RTL interface, Arabic invoice documents, international clients and multilingual payment reminders.",
    relatedLinks: [{ href:"/ar", label:"FaturaPro بالعربية" }, { href:"/ar/invoicing-netherlands-germany-belgium", label:"دليل الفوترة بالعربية في هولندا وألمانيا وبلجيكا" }],
    date: "2026-07-19",
    ...
    sections: [
      { h: "Choosing Invoicing Software for Arabic-Speaking Businesses", p: "An Arabic-speaking freelancer may manage their business in Arabic while invoicing clients in several other languages. Compare interface language, document labels, right-to-left layout and payment-reminder language separately. A translated homepage alone does not tell you what the application can do." },
      ...
      { h: "Bilingual Is Even Better", p: "Many Arabic-speaking business owners work with international clients too. That's why bilingual Arabic-English invoicing matters: you send Arabic invoices to local clients and English ones to international clients, from the same account, without switching tools. Check which document languages are actually available, and write your service descriptions in the language your customer understands." },
      ...
      { h: "Where Fatura Pro Fits", p: "Fatura Pro supports Arabic sign-in and primary navigation with a right-to-left layout. Invoice labels are available in Arabic, English, Dutch and French, independently of the interface language. Essential payment-reminder templates are available in Arabic, English, Dutch, French and Spanish: review the text and open email or WhatsApp to send it yourself. Some secondary screens can still use English. UBL/XML export is available on Essential, but Peppol delivery is not provided." },
      { h: "Try the Invoice Workflow", p: "You can create a free account with no card. The Free plan includes up to 20 invoices and 5 clients. New accounts receive seven days of Essential features, including unlimited invoices, editable reminders, deposits and UBL/XML export. Advanced features require the Advanced plan." },
    ],
  },
  {
    ...
    sections: [
      ...
      { h: "How Fatūra Pro Supports the Workflow", p: "Fatūra Pro provides an English interface, client records, invoice and credit-note creation, PDF output, 18 invoice currencies, deposits and partial payments. It marks overdue invoices and prepares editable reminder text that opens in email or WhatsApp for you to review and send. The Advanced plan adds expenses and VAT summaries; those summaries support bookkeeping but do not file a return with the Belastingdienst." },
    ...
    faqs: [
      ...
      { q: "Does Fatūra Pro file my Dutch VAT return?", a: "No. The Advanced plan provides expense and VAT summaries to support bookkeeping, but it does not submit a VAT return to the Belastingdienst." },
