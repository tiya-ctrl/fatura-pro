...
const POSTS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "Frequently Asked Questions", p: "The Free plan has no time limit and requires no card. All plans support 18 invoice currencies, kept as separate totals. Sign-in and primary navigation support English, Dutch, French, Spanish and Arabic; invoice labels support English, Dutch, French and Arabic. Reminder templates support all five interface languages. Team access is an Advanced feature with up to five members." },
