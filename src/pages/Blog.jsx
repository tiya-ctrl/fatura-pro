  ...
  },
{
    ...
    sections: [
      ...
      { h: "Where Fatura Pro Fits", p: "Fatura Pro supports Arabic sign-in and primary navigation with a right-to-left layout. Invoice labels are available in Arabic, English, Dutch and French, independently of the interface language. Pro payment-reminder templates are available in Arabic, English, Dutch, French and Spanish: review the text and open email or WhatsApp to send it yourself. Some secondary screens can still use English. UBL/XML export is available on Pro, but Peppol delivery is not provided." },
