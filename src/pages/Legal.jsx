...
const PAGE_DATA = {
  ...
  terms: {
    ...
    sections: [
      ...
      ["2. Service Description", "FaturaPro provides online invoicing software for freelancers, small businesses and agencies. Features and limits are shown on the pricing page and may require Free, Essential or Advanced. Advanced quotes can be saved, previewed, printed or saved as PDF, and converted to invoices. Opening an email for a quote does not attach or send the PDF automatically; the user must review and attach it in their own mail app. Payment reminders are prepared for you to review and send. Recurring schedules create pending invoices for review; they do not send invoices unattended."],
      ...
      ["4. Payments and Subscriptions", "Essential is billed monthly at €9 and Advanced at €19 through Stripe. Stripe checkout shows the amount before purchase. You can manage or cancel a subscription from the billing portal, and cancellation normally stops renewal at the end of the current paid period. Contact support@faturapro.app if you believe a charge is incorrect."],
      ["5. Free Plan and Trial", "The Free plan is subject to the limits shown on the pricing page. New accounts receive a seven-day trial of Essential features and do not need a card for that trial. When it ends, the account uses the Free plan unless a paid subscription is active."],
