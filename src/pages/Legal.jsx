        ...
        {isPrivacy ? (
          ...
          <>
            ...
            {[
              ...
              ["3. Commission Period", "Commission is available for the first twelve paid months of each qualified customer, starting with that customer's first successful subscription payment. The customer-specific end timestamp is recorded automatically, and payments received at or after it create no commission."],
              ["4. Commission Calculation", "The rate is selected automatically from the customer's paid plan: 25% of eligible Pro subscription revenue and 35% of eligible Business subscription revenue, excluding tax. A payment later refunded, reversed, disputed or credited becomes ineligible and its commission is reversed. The dashboard is the record of pending, available, processing, paid and reversed commission."],
