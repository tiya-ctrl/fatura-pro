      ...
      <div style={{ maxWidth:720, margin:"0 auto", padding:"60px 24px" }}>
        ...
        {isPrivacy ? (
          ...
          <>
            ...
            <p style={{ color:"#9a9690", marginBottom:40 }}>Last updated: August 2026</p>
            {[
              ["1. Approval and Agreement", "Participation begins only after Fatūra Pro approves an application. Applying does not guarantee approval. Approved ambassadors receive a private dashboard, tracked link and payout setup instructions by email."],
              ...
              ["3. Commission Period", "The standard commission period is the first twelve paid months of each qualified customer, starting with that customer's first successful subscription payment. An approved ambassador may receive a different written customer term in the acceptance email and private dashboard. The customer-specific end timestamp is recorded automatically, and payments received at or after it create no commission."],
              ["4. Commission Calculation", "The standard rates are 25% of eligible Pro subscription revenue and 35% of eligible Business subscription revenue, excluding tax. If Fatūra Pro approves custom rates, the acceptance email and private dashboard show the applicable Pro rate, Business rate and customer term. The customer's paid plan selects the matching approved rate automatically. A payment later refunded, reversed, disputed or credited becomes ineligible and its commission is reversed. The dashboard is the record of pending, available, processing, paid and reversed commission."],
