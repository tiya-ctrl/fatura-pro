...
const PAGE_DATA = {
  privacy: {
    ...
    sections: [
      ...
      ["7. Cookies, Referral Attribution and Analytics", "Strictly necessary storage keeps sessions and preferences working. A first-party referral code and anonymous click identifier may be kept for up to thirty days after someone follows a member or ambassador link. Ambassadors see aggregate counts rather than referred customers' names or email addresses. Vercel Analytics measures product and page use. Microsoft Clarity is optional and loads only after analytics consent. We do not sell personal data or use advertising cookies."],
