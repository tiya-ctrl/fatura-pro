  ...
  <div style={{ background: "rgba(201,168,76,0.12)", border: "1px solid var(--gold)", borderRadius: 10,
    ...
    <div style={{ display: "flex", gap: 8 }}>
      ...
      <button className="btn btn-primary btn-sm" onClick={() => setShowEditDraftBanner(false)}>Continue ✓</button>
        ...
        {step === 2 && (
          <div>
            <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 60px 100px 90px 28px", gap:8, padding:"6px 12px", background:"var(--bg3)", borderRadius:8, border:"1px solid var(--border)", marginBottom:6 }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:6, marginBottom:12 }}>
              {items.map((it, idx) => (
                <div key={idx} style={{ display:"flex", flexDirection:"column", background:"var(--bg4)", borderRadius:8, border:"1px solid var(--border)", overflow:"hidden" }}>
                  <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 60px 100px 90px 28px", gap:8, padding:"8px 12px", alignItems:"center" }}>
